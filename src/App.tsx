...
function App() {
  ...
  const Navigation = () => (
    // <nav className="fixed top-0 left-0 right-0 bg-white backdrop-md z-50 border-b border-white shadow-sm">
     <nav className="fixed top-0 left-0 right-0 bg-white border-b border-white shadow-sm z-50">
...
//             <img src={panIndiaLogo} alt="PanIndia Logistics" className="h-12 w-auto" />
//           </div>
...
//           >
//             {isMenuOpen ? (
//               <X size={24} className={scrollY > 50 ? 'text-gray-800' : 'text-white'} />
//             ) : (
//               <Menu size={24} className={scrollY > 50 ? 'text-gray-800' : 'text-white'} />
//             )}
//           </button>
//         </div>
//       </div>
...
//   // Your other page components would go here (HomePage, AboutPage, ServicesPage)
//   // For brevity, I'm only showing the contact page integration
...
//                   <p className="text-gray-300">H.No. 6-4-15/2/1, Shop No. 3&4, Ground Floor, Opp. Traffic Police Station, Aramghar 'X' Road, Shivarampally, Hyderabad-500052.</p>
//                 </div>
//               </div>
...
// import { Mail, Phone, Clock, Home, ArrowRight, X } from 'lucide-react';
...
// import React, { useState } from 'react';
// import { Mail, Phone, Clock, Home, ArrowRight } from 'lucide-react';
...
//               {showPopup && (
//                 <div className="mt-8 p-6 bg-green-100 border border-green-400 text-green-800 rounded-lg shadow-lg">
...
//                     <h4 className="text-xl font-bold mb-2">Address</h4>
//                     <p className="text-gray-300">
//                       H.No. 6-4-15/2/1, Shop No. 3&4, Ground Floor, Opp. Traffic Police Station, Aramghar 'X' Road,
...
//           <div className="bg-white text-center p-12 rounded-lg shadow-xl max-w-md w-full">
//             <h2 className="text-4xl font-bold text-[#000066] mb-4">Thank You!</h2>
//             <p className="text-lg text-gray-700">Your shipment request has been submitted successfully.</p>
//             <button
//               onClick={() => setShowPopup(false)}
//               className="mt-6 px-6 py-3 bg-[#000066] text-white rounded hover:bg-[#000088]"
//             >
//               Close
//             </button>
//           </div>
...
//               <h2 className="text-4xl font-black mb-8 text-[#000066]">Get Your Quote</h2>
//               <form onSubmit={handleSubmit} className="space-y-8">
//                 <input type="hidden" name="access_key" value="a3e2feb2-b8e4-49d7-a9ea-53c841498cca" />
//                 <input type="hidden" name="subject" value="New Shipment Request from Website" />
//                 <input type="hidden" name="from_name" value="PanIndia Logistics Website" />
...
//                     <h4 className="text-xl font-bold mb-2">Address</h4>
//                     <p className="text-gray-300">
//                       H.No. 6-4-15/2/1, Shop No. 3&4, Ground Floor, Opp. Traffic Police Station, Aramghar 'X' Road, Shivarampally, Hyderabad-500052.
//                     </p>
//                   </div>
//                 </div>
//                 <div className="mt-12 pt-8 border-t border-gray-600">
...
//           // Delay reset for smoother experience
//           setTimeout(() => {
//             form.reset();
//           }, 1000);
//         }
...
//   return (
//     <div className={`pt-20 relative ${showPopup ? "overflow-hidden h-screen" : ""}`}>
//       {/* ✅ Thank You Popup */}
//       {showPopup && (
//         <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
//           <div className="bg-white rounded-xl p-10 max-w-md w-full text-center shadow-2xl relative">
...
//           </h1>
//           <p className="text-xl text-gray-50 leading-relaxed">
//             Ready to ship? Get in touch with us and we'll handle the rest with our expert logistics
//             team.
//           </p>
//         </div>
//       </section>
...
//         style={{
//           backgroundImage:
//             "linear-gradient(rgba(0,0,102,0.8), rgba(0,0,102,0.9)), url('https://images.pexels.com/photos/2199293/pexels-photo-2199293.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop')",
//           backgroundSize: 'cover',
//           backgroundPosition: 'center',
//         }}
//       >
...
//     const payload = new FormData();
//     payload.append('access_key', 'f8441138-0f5f-4de6-ad47-ebfc8db05d65');
//     payload.append('subject', 'New Shipment Request from Website');
//     payload.append('from_name', 'PanIndia Logistics Website');
//     Object.entries(formData).forEach(([key, val]) => payload.append(key, val));
...
//     const payload = new FormData();
//     payload.append('access_key', 'a3e2feb2-b8e4-49d7-a9ea-53c841498cca');
//     payload.append('subject', 'New Shipment Request from Website');
//     payload.append('from_name', 'PanIndia Logistics Website');
//     Object.entries(formData).forEach(([key, val]) => payload.append(key, val));
...
// import { ArrowRight, Clock, Home, Mail, Phone, X } from "lucide-react";
...
// import React, { useState, useEffect } from "react";
// import { ArrowRight, X, Mail, Phone, Clock, Home } from "lucide-react";
...
//             </a>
//             <a
//               href="mail@panindialogistics.in"
//               className="w-12 h-12 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gray-700 transition-colors cursor-pointer"
//             >
//               <Mail size={20} />
//             </a>
